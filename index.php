...
$result = mysqli_query($mysqli, "SELECT * FROM wp_posts where post_type='attachment' and post_mime_type='image/jpeg' ORDER BY id DESC"); // using mysqli_query instead

?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>iSPOTTED</title>
    <meta charset="utf-8">
				...
				<div class="photograhy">
					<div class="row no-gutters">
						...
						<div class="col-md-4 ftco-animate">
							<a href="<?php echo $res['guid'] ?>" class="photography-entry img image-popup d-flex justify-content-center align-items-center" style="background-image: url(<?php echo $res['guid'] ?>);">
								<div class="overlay"></div>
								<div class="text text-center">
									<h3><?php echo $res['post_title']; ?></h3>
									<span class="tag"><?php echo $res['post_excerpt']; ?></span>
								</div>
							</a>
						</div>
